package com.nic.qrcodescanner.Application;
...
import com.nic.qrcodescanner.Api.LruBitmapCache;
...
public class NICApplication extends Application {
    ...
    private SSLSocketFactory getSocketFactory() {
        ...
        try {
            ...
            InputStream caInput = getResources().openRawResource(R.raw.hrce);
            Certificate ca;
            try {
            ...
            HostnameVerifier hostnameVerifier = new HostnameVerifier() {
                ...
                public boolean verify(String hostname, SSLSession session) {
                    ...
                    return hostname.compareTo(UrlGenerator.getTnhrceHostName())==0; //The Hostname of your server

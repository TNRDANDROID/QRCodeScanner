package com.nic.qrcodescanner.helper;
...
public class AppVersionHelper implements Api.ServerResponseListener {
    ...
    public void callAppVersionCheckApi() {
        new ApiService(mContext).makeRequest("versionCheck", Api.Method.POST, UrlGenerator.getCommonUrl(), versionCheckParams(), "not cache", this);
